...
# Initialize the model with provider toggle
model = WatsonxModel() if os.getenv("LLM_PROVIDER","google").lower()=="watsonx" \
        else genai.GenerativeModel(model_name=config.GEMINI_MODEL)
