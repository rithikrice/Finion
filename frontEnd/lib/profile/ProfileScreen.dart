...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  bool googleAssistantEnabled = false;
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                _buildToggleRow('Alexa', alexaEnabled, (value) {
                  setState(() => alexaEnabled = value);
                }),
                _buildToggleRow('Google Assistant', googleAssistantEnabled, (
                  value,
                ) {
                  setState(() => googleAssistantEnabled = value);
                }),
                const SizedBox(height: 24),
                const Divider(),
                ListTile(
